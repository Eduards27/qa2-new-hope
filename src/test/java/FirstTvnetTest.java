...
public class FirstTvnetTest {
    ...
    private final By LOCATOR_BY_NAME = By.className("elementClassName");
    private final By LOCATOR_BY_XPATH = By.xpath(".//*[contains(@class,'structured-content__block structured-content__block--single flex flex\");
